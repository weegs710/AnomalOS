{
  ...
  # Nix daemon configuration - always enabled (core system feature)
  # Includes: garbage collection, optimizations, helper scripts, aliases
  ...
  environment.shellAliases = {
    ...
    gui-up = "cp ~/.config/noctalia/gui-settings.json ~/dotfiles/features/noctalia/gui-settings.json";
