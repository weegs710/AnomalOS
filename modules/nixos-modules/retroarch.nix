    ...
    with lib; {
      config = mkIf config.mySystem.features.gaming {
        home-manager.users.${config.mySystem.user.name} = {
          ...
          home.file.".config/retroarch/config/Nestopia UE/Nestopia UE.opt".text = ''
          ...
          home.file.".config/retroarch/config/bsnes/bsnes.opt".text = ''
          ...
          home.file.".config/retroarch/config/Mupen64Plus-Next/Mupen64Plus-Next.opt".text = ''
          ...
          home.file.".config/retroarch/config/Gambatte/Gambatte.opt".text = ''
          ...
          home.file.".config/retroarch/config/mGBA/mGBA.opt".text = ''
          ...
          home.file.".config/retroarch/config/DeSmuME/DeSmuME.opt".text = ''
          ...
          home.file.".config/retroarch/config/Genesis Plus GX/Genesis Plus GX.opt".text = ''
          ...
          home.file.".config/retroarch/config/Beetle Saturn/Beetle Saturn.opt".text = ''
          ...
          home.file.".config/retroarch/config/Flycast/Flycast.opt".text = ''
          ...
          home.file.".config/retroarch/config/Beetle PSX HW/Beetle PSX HW.opt".text = ''
          ...
          home.file.".config/retroarch/config/PCSX2/PCSX2.opt".text = ''
          ...
          home.file.".config/retroarch/config/PPSSPP/PPSSPP.opt".text = ''
          ...
          home.file.".config/retroarch/config/MAME/MAME.opt".text = ''
          ...
          home.file.".config/retroarch/config/FBNeo/FBNeo.opt".text = ''
          ...
          home.file.".config/retroarch/config/Stella/Stella.opt".text = ''
            stella_console = "auto"
          ...
          home.file.".config/retroarch/config/Beetle PCE Fast/Beetle PCE Fast.opt".text = ''
