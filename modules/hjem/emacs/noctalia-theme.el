...
(let* ((bg "#212337")
  ...
  (custom-theme-set-faces
   ...
   ;; transient -- ghostty ANSI palette, same source as vterm faces
   `(transient-heading         ((t (:foreground "#a48cf2" :weight bold :slant italic :underline t))))  ; bright purple
   `(transient-key             ((t (:foreground "#66e4fd" :weight bold))))  ; bright cyan -- base/fallback
   `(transient-key-exit        ((t (:foreground "#66e4fd" :weight bold))))  ; bright cyan -- leaf commands
   `(transient-key-stay        ((t (:foreground "#66e4fd" :weight bold))))  ; bright cyan -- stay-in suffixes
   `(transient-key-stack       ((t (:foreground "#66e4fd" :weight bold))))  ; bright cyan -- sub-menus (exit parent)
   `(transient-key-recurse     ((t (:foreground "#66e4fd" :weight bold))))  ; bright cyan -- sub-menus (return to parent)
   `(transient-key-return      ((t (:foreground "#66e4fd" :weight bold))))  ; bright cyan -- return keys
   `(transient-key-noop        ((t (:foreground "#434b6e"))))
   `(transient-enabled-suffix  ((t (:foreground "#37f499"))))
   `(transient-disabled-suffix ((t (:foreground "#7081d0"))))
   `(transient-unreachable     ((t (:foreground "#606b9d"))))
   `(transient-unreachable-key ((t (:foreground "#434b6e"))))
   `(transient-inapt-suffix    ((t (:foreground "#606b9d"))))
   `(transient-mismatched-key  ((t (:foreground "#f1fc79" :weight bold))))
   `(transient-nonstandard-key ((t (:foreground "#e9f941" :underline t))))
   `(transient-separator       ((t (:background ,surface-container-high :foreground ,surface-container-high))))
   `(transient-active-infix    ((t (:background "#3305c6" :foreground "#dbd1fa"))))
   `(transient-posframe        ((t (:background ,surface-container))))
   `(transient-posframe-border ((t (:background "#04d1f9"))))
