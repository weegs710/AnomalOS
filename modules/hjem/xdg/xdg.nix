      ...
      hjem.users.${username} = {
        xdg.config.files = {
          ...
          "mimeapps.list".text = ''
            ...
            video/3gpp=kodi.desktop
            video/3gpp2=kodi.desktop
            video/mp4=kodi.desktop
            video/mpeg=kodi.desktop
            video/ogg=kodi.desktop
            video/quicktime=kodi.desktop
            video/webm=kodi.desktop
            video/x-flv=kodi.desktop
            video/x-m4v=kodi.desktop
            video/x-matroska=kodi.desktop
            video/x-msvideo=kodi.desktop
            video/x-ogm=kodi.desktop
