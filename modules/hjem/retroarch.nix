  ...
  in {
    ...
    hjem.users.${username} = {
      xdg.config.files = {
        ...
        "retroarch/config/Nestopia UE/Nestopia UE.opt".text = ''
        ...
        "retroarch/config/bsnes/bsnes.opt".text = ''
        ...
        "retroarch/config/Mupen64Plus-Next/Mupen64Plus-Next.opt".text = ''
        ...
        "retroarch/config/Gambatte/Gambatte.opt".text = ''
        ...
        "retroarch/config/mGBA/mGBA.opt".text = ''
        ...
        "retroarch/config/Genesis Plus GX/Genesis Plus GX.opt".text = ''
        ...
        "retroarch/config/Beetle Saturn/Beetle Saturn.opt".text = ''
        ...
        "retroarch/config/Flycast/Flycast.opt".text = ''
        ...
        "retroarch/config/Beetle PSX HW/Beetle PSX HW.opt".text = ''
        ...
        "retroarch/config/PCSX2/PCSX2.opt".text = ''
        ...
        "retroarch/config/PPSSPP/PPSSPP.opt".text = ''
        ...
        "retroarch/config/Stella/Stella.opt".text = ''
          stella_console = "auto"
        ...
        "retroarch/config/Beetle PCE Fast/Beetle PCE Fast.opt".text = ''
